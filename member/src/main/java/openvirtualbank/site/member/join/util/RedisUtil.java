...
public class RedisUtil {
	...
	public void saveAuthNumber(String key, String salt, String emailAuthNumber, Long expiration) {
	...
	public void deleteKey(String key, String email) {
		String salt = redisTemplate.opsForValue().get(SALT_PREFIX + key);
